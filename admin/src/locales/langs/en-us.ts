const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'user-service_activation-code': 'Carmi exchange',
    'user-service_dialog': 'Dialogue data',
    'user-service_dialog_all-dialog': 'All dialogue',
    'user-service_dialog_dialog-detail': 'Dialogue details',
    'user-service_dialog_star-dialog-detail': 'Collecting dialogue',
    'user-service_feedback': 'Feedback',
    'user-service_promotion': 'Invitation Information',
    'user-service_punch-in-daily': 'Punch in daily',
    'user-service_task-reward': 'Task rewards',
    'user-service_user': 'User data',
