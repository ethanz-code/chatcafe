const local: App.I18n.Schema = {
  ...
  route: {
    'user-center': '个人中心',
    'user-service': '用户服务',
    'user-service_activation-code': '卡密兑换',
    'user-service_dialog': '对话数据',
    'user-service_dialog_all-dialog': '全部对话',
    'user-service_dialog_dialog-detail': '对话详情',
    'user-service_dialog_star-dialog-detail': '收藏对话',
    'user-service_feedback': '意见反馈',
    'user-service_promotion': '邀请信息',
    'user-service_punch-in-daily': '每日打卡',
    'user-service_task-reward': '任务奖励',
    'user-service_user': '用户数据',
    recharge: '充值系统',
    recharge_goods: '商品管理',
    recharge_order: '订单管理',
    chat: 'AI聊天',
