...
declare module "@elegant-router/types" {
  ...
  export type LastLevelRouteKey = Extract<
    ...
    | "user-service_dialog_dialog-detail"
    | "user-service_dialog_star-dialog-detail"
    | "user-service_feedback"
    | "user-service_promotion"
    | "user-service_punch-in-daily"
    | "user-service_task-reward"
    | "user-service_user"
  >;
